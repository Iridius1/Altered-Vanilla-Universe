You can find all your savefiles on steam folder where you got steam installed, go to userdata and uses the find function to find a folder 
called 329130 then after you open it go to remote folder and open the data folder inside you should find all your saves files there.

Backup your saves by copying all the files to somewhere else in your computer's directory
...
----------------------------------------------------------------------------------------------
Please extract the .rar files once you download the mod this way
